set -gx CONDA_EXE (cygpath "D:/miniconda3\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "D:/miniconda3")
set _CONDA_EXE (cygpath "D:/miniconda3\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "D:/miniconda3\python.exe")
